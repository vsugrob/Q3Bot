...
namespace Utils
{
    ...
    ///     data types.
    ///     All info taken from the meta data of BitConverter. This implementation
    ///     allows for Endianness consideration.
    ///</summary>
    public static class ExBitConverter
    {
        /// <summary>
        ...
        ///</summary>
        public static long DoubleToInt64Bits(double value, bool isLittleEndian ) { throw new NotImplementedException(); }
        ///
        /// <summary>
        ...
        ///</summary>
        public static byte[] GetBytes(bool value, bool isLittleEndian )
        {
            if (isLittleEndian)
            {
        ...
        ///</summary>
        public static byte[] GetBytes(double value, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
                return BitConverter.GetBytes(value);
        ...
        ///</summary>
        public static byte[] GetBytes(float value, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
                return BitConverter.GetBytes(value);
        ...
        ///</summary>
        public static double Int64BitsToDouble(long value, bool isLittleEndian) { throw new NotImplementedException(); }
        ///
        /// <summary>
        ...
        ///</summary>
        public static bool ToBoolean(byte[] value, int startIndex, bool isLittleEndian) { throw new NotImplementedException(); }
        ///
        /// <summary>
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static char ToChar(byte[] value, int startIndex, bool isLittleEndian) { throw new NotImplementedException(); }
        ///
        /// <summary>
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static double ToDouble(byte[] value, int startIndex, bool isLittleEndian) { throw new NotImplementedException(); }
        ///
        /// <summary>
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static short ToInt16(byte[] value, int startIndex, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static int ToInt32(byte[] value, int startIndex, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static long ToInt64(byte[] value, int startIndex, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static float ToSingle(byte[] value, int startIndex, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
        ...
        ///     value is null.
        ///</summary>
        public static string ToString(byte[] value, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
        ...
        ///     startIndex is less than zero or greater than the length of value minus 1.
        ///</summary>
        public static string ToString(byte[] value, int startIndex, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
        ...
        ///</summary>
        public static string ToString(byte[] value, int startIndex, int length, bool isLittleEndian)
        {
            if (isLittleEndian)
            {
